...
//                    })
        ...
        private fun getFullAuto(startingPositions: StartingPositions, scaleOwnedSide: MatchData.OwnedSide) = commandGroup {
            ...
            addSequential(commandGroup {
                addSequential(commandGroup {
                    ...
                    addParallel(commandGroup {
                        ...
                        addSequential(object : MotionProfileCommand2(if (nearScale) FastTrajectories.scaleToCube1 else FastTrajectories.scaleToFar1, pathMirrored = scaleOwnedSide == MatchData.OwnedSide.RIGHT) {
            ...
            // 2nd Cube in Scale
            addSequential(commandGroup {
                val dropSecondCubePath = object : MotionProfileCommand2(if (nearScale) FastTrajectories.cube1ToScale else FastTrajectories.far1ToScale, pathMirrored = scaleOwnedSide == MatchData.OwnedSide.RIGHT) {
                    override fun isFinished(): Boolean {
